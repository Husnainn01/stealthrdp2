          ...
          <div className="text-right">
            {plan.monthlyPrice !== null ? (
              <>
                ...
                <div className="font-bold text-2xl text-white flex items-end justify-end gap-1">
                ...
                {plan.regularMonthlyPrice && billingCycle === 'monthly' && (
                  <div className="inline-flex items-center mt-1">
                    ...
                    <span className="bg-cyber text-xs text-charcoal px-1.5 py-0.5 rounded-sm">
                      Save {getDiscount(billingCycle)}%
                    </span>
                  </div>
                )}
                
                {/* Billing cycle price details */}
                      ...
                      <span className="text-sm text-white">
                        Total: €{
                          billingCycle === 'quarterly' 
                            ? plan.quarterlyPrice.toFixed(2)
                            : billingCycle === 'annually'
                              ? plan.annuallyPrice.toFixed(2)
                              : plan.biannuallyPrice.toFixed(2)
                        }
                      </span>
                      <span className="text-xs text-gray-400 line-through">
                        €{
                          billingCycle === 'quarterly' 
                            ? (plan.quarterlyPrice / 0.9).toFixed(2)
                            : billingCycle === 'annually'
                              ? (plan.annuallyPrice / 0.8).toFixed(2)
                              : (plan.biannuallyPrice / 0.7).toFixed(2)
                        }
                      </span>
                    </div>
                    <span className="bg-cyber text-xs text-charcoal px-1.5 py-0.5 rounded-sm whitespace-nowrap">
                      Save {getDiscount(billingCycle)}%
                    </span>
                  </div>
                )}
