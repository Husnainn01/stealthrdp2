          ...
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-4 md:gap-x-12 lg:gap-x-16 max-w-5xl mx-auto">
            ...
            <div className="flex items-center gap-2 text-white/80 hover:text-white transition-colors">
             ...
             <div className="flex items-center gap-2 text-white/80 hover:text-white transition-colors">
              ...
              <span className="font-montserrat text-sm uppercase tracking-wider">Trusted by 28,750+ Users</span> 
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
              ...
              <div className="lg:col-span-3">
                <span className="inline-block px-3 py-1 rounded-full bg-electric/10 text-electric text-xs font-medium mb-4">JOIN 28,750+ SERVER OWNERS</span>
