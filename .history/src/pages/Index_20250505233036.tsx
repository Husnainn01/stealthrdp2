...
const Index = () => {
  return (
    <Layout>
      ...
      <section className="py-6 bg-midnight">
        <div className="container">
          <p className="text-center text-white/50 text-sm font-montserrat uppercase tracking-wider mb-4">Powering Businesses Worldwide</p>
      ...
      <section className="py-12 md:py-16 bg-midnight">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-midnight border-2 border-electric rounded-xl overflow-hidden relative card-hover shadow-lg shadow-electric/20 flex flex-col scale-[1.02]">
      ...
      <section className="py-12 md:py-16 bg-charcoal">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16 md:mb-24">
            <div className="md:order-2 flex justify-center items-center p-8 bg-midnight rounded-lg aspect-video border border-white/10 shadow-lg">
              <Zap className="h-24 w-24 md:h-32 md:w-32 text-cyber opacity-80" strokeWidth={1} />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="flex justify-center items-center p-8 bg-midnight rounded-lg aspect-video border border-white/10 shadow-lg">
              <ShieldCheck className="h-24 w-24 md:h-32 md:w-32 text-electric opacity-80" strokeWidth={1} />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16 md:mt-24">
             <div className="md:order-2 flex justify-center items-center p-8 bg-midnight rounded-lg aspect-video border border-white/10 shadow-lg">
               <Code size={16} className="h-24 w-24 md:h-32 md:w-32 text-cyber opacity-80" strokeWidth={1} />
             </div>
             <div className="md:order-1">
