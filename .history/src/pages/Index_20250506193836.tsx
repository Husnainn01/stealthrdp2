      ...
      <div className="max-w-lg mx-auto mb-10">
        <div className="bg-charcoal/50 rounded-lg p-2 flex items-center">
          <div className="grid grid-cols-4 gap-2 w-full">
            ...
            <div 
              className={`${billingPeriod === 'biannual' ? 'bg-midnight border border-electric' : ''} text-center py-2 px-2 rounded cursor-pointer hover:bg-midnight/50 transition-colors bg-midnight/20 border border-electric/10`}
