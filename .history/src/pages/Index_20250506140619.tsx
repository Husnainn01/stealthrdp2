...
const Index = () => {
  ...
  return (
    <Layout>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="fade-in" style={{ animationDelay: '0.6s' }}>
              <p className="text-white/80 text-sm mb-2">Trusted by businesses in 45+ countries worldwide</p>
              <div className="flex items-center justify-center mt-3 animate-bounce">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-electric">
                  <path d="M12 5v14M5 12l7 7 7-7"/>
                </svg>
                <span className="ml-2 text-electric text-sm font-medium">Scroll for special offers</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 bg-midnight border-b border-white/5">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {/* Action 1: Free Trial */}
            <a href="https://stealthrdp.com/dash/index.php?rp=/store/free-trial" className="flex flex-col items-center p-4 rounded-lg bg-gradient-to-br from-midnight to-charcoal border border-electric/20 hover:border-electric/60 transition-all hover:shadow-[0_0_15px_rgba(0,240,255,0.15)] group">
              <div className="bg-electric/10 p-3 rounded-full mb-3 group-hover:bg-electric/20 transition-all">
                <Cpu size={24} className="text-electric" />
              </div>
              <h3 className="font-montserrat font-semibold text-white mb-1">Start Free Trial</h3>
              <p className="text-white/60 text-sm text-center">Test our platform with a 24-hour free trial. No credit card required.</p>
            </a>
            
            {/* Action 2: Configure Custom VPS */}
            <a href="https://stealthrdp.com/dash/index.php?rp=/store/build-your-own-rdp-vps" className="flex flex-col items-center p-4 rounded-lg bg-gradient-to-br from-midnight to-charcoal border border-cyber/20 hover:border-cyber/60 transition-all hover:shadow-[0_0_15px_rgba(34,212,107,0.15)] group">
              <div className="bg-cyber/10 p-3 rounded-full mb-3 group-hover:bg-cyber/20 transition-all">
                <Settings size={24} className="text-cyber" />
              </div>
              <h3 className="font-montserrat font-semibold text-white mb-1">Custom Configuration</h3>
              <p className="text-white/60 text-sm text-center">Build your perfect VPS with exact specs you need for your workload.</p>
            </a>
            
            {/* Action 3: Special Offers */}
            <a href="https://stealthrdp.com/dash/index.php?rp=/store/special-offers" className="flex flex-col items-center p-4 rounded-lg bg-gradient-to-br from-midnight to-charcoal border border-white/10 hover:border-white/30 transition-all hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] group">
              <div className="bg-white/10 p-3 rounded-full mb-3 group-hover:bg-white/15 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white/80 h-6 w-6">
                  <path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" />
                  <line x1="7" y1="7" x2="7.01" y2="7" />
                </svg>
              </div>
              <h3 className="font-montserrat font-semibold text-white mb-1">Limited-Time Offers</h3>
              <p className="text-white/60 text-sm text-center">Save up to 45% on select VPS plans with our current promotions.</p>
            </a>
          </div>
        </div>
      </section>
