...
import { Check, Shield, Cpu, Database, Server, HardDrive, Settings } from 'lucide-react';
...
const Plans = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: ['Windows/Linux OS', '24/7 Premium Support', 'Root Access', '99.9% Uptime', 'Free Domain', 'Daily Backups', 'Dedicated IP']
    },
    {
      name: 'Ultimate VPS',
      ...
      features: ['Windows/Linux OS', '24/7 Premium Support', 'Root Access', '99.9% Uptime', 'Free Domain', 'Daily Backups', 'Dedicated IP', 'Load Balancing']
    },
    {
      ...
      monthlyPrice: null, // Custom pricing based on configuration
      yearlyPrice: null,
      specs: {
        cpu: 'Custom CPU',
        ram: 'Custom RAM',
        ...
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {plans.map((plan, index) => (
              <Card key={index} className={`bg-midnight border-gray-800 hover:border-electric transition-all duration-300 card-hover ${plan.isCustom ? 'border-cyber' : ''}`}>
