        ...
        <div className="container">
          ...
          <div className="plans-container">
              ...
              >
                {usaPlans.map((plan, index) => (
                  <SwiperSlide key={`usa-${index}`}>
                    <div className={`bg-midnight border ${plan.popular ? 'border-2 border-electric' : 'border-white/10'} rounded-xl overflow-hidden card-hover h-full flex flex-col plan-card p-5`}>
                      {plan.popular && (
                      ...
                      <div className="plan-card-footer mt-auto">
                        <Button asChild className={`w-full ${plan.popular ? 'btn-electric' : 'border border-electric text-electric hover:bg-electric/10 transition-colors'}`}>
              ...
              >
                {euPlans.map((plan, index) => (
                  <SwiperSlide key={`eu-${index}`}>
                    <div className="bg-midnight border border-white/10 rounded-xl overflow-hidden card-hover h-full flex flex-col plan-card p-5">
                      <div className="plan-card-content">
                        <h4 className="text-xl font-bold font-montserrat text-white mb-1">{plan.name}</h4>
                        <p className="text-white/70 text-sm mb-4">{plan.description}</p>
            ...
            <div className="plan-section">
              ...
              <div className="bg-midnight border border-white/10 rounded-xl overflow-hidden card-hover h-full flex flex-col p-5">
                <div className="plan-card-content">
