        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 rounded-lg bg-midnight/50 border border-white/10 card-hover">
              ...
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Remote Desktop & Work</h3>
              <p className="text-white/70 text-sm leading-relaxed">
                Access your secure Windows desktop environment from anywhere, ensuring productivity on the go.
              </p>
            </div>
            {/* Card 2: Web Hosting */}
            <div className="text-center p-6 rounded-lg bg-midnight/50 border border-white/10 card-hover">
              <Server className="h-10 w-10 text-cyber mx-auto mb-4" strokeWidth={1.5} />
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">High-Performance Hosting</h3>
              <p className="text-white/70 text-sm leading-relaxed">
                Host websites, applications, or databases with dedicated resources and NVMe speed for optimal performance.
              </p>
            </div>
            {/* Card 3: Development */}
            <div className="text-center p-6 rounded-lg bg-midnight/50 border border-white/10 card-hover">
              <Code className="h-10 w-10 text-electric mx-auto mb-4" strokeWidth={1.5} />
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Development Environments</h3>
              <p className="text-white/70 text-sm leading-relaxed">
                Create isolated, secure environments for coding, testing, and deploying your software projects.
              </p>
            </div>
            {/* Card 4: Specialized Software */}
            <div className="text-center p-6 rounded-lg bg-midnight/50 border border-white/10 card-hover">
              <Bot className="h-10 w-10 text-cyber mx-auto mb-4" strokeWidth={1.5} />
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Run Specialized Software</h3>
              <p className="text-white/70 text-sm leading-relaxed">
                Deploy trading bots, game servers, automation tools, or any application requiring consistent uptime and control.
              </p>
            </div>
          </div>
        </div>
