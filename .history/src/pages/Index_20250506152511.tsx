              ...
              <div className="p-5 border-b border-white/10 bg-charcoal/50">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-white/90 font-medium mb-2">Before StealthRDP</h3>
                    <p className="text-white/60 text-sm">
                      "My gaming server lags when friends join, and I have to keep my PC running 24/7."
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-white/90 font-medium mb-2">With StealthRDP</h3>
                    <p className="text-white/60 text-sm">
                      "Our gaming experience is smooth with zero lag, and I can turn off my PC without interrupting gameplay."
                    </p>
                    <div className="mt-4 flex items-center">
                      <Gamepad2 className="h-6 w-6 text-electric" strokeWidth={1.5} />
                      <span className="ml-2 text-xs text-white/80 font-medium">Private Gaming Realm</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 flex justify-center">
            <div className="bg-midnight/50 border border-white/10 rounded-lg py-3 px-6 inline-flex items-center gap-4">
              <p className="text-white/60 text-sm flex items-center gap-2">
                ...
                <span>5,219 customers have solved these problems</span>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center mt-10 gap-5">
            ...
            <div className="bg-electric/5 border border-electric/10 rounded-lg py-3 px-6 flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <p className="text-white text-sm font-medium">100% Risk-Free Guarantee</p>
                <p className="text-white/60 text-xs">7-day money-back on all plans, no questions asked</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
              ...
              <div className="lg:col-span-3">
                <span className="inline-block px-3 py-1 rounded-full bg-electric/10 text-electric text-xs font-medium mb-4">JOIN 5,000+ SERVER OWNERS</span>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <h3 className="text-white font-medium">Zero Risk</h3>
                      <p className="text-white/60 text-sm">7-day money-back guarantee. Not satisfied? Get a full refund.</p>
                    </div>
                  </div>
      ...
      <script dangerouslySetInnerHTML={{
        __html: `
          function calculateSavings() {
            ...
            const managementHours = parseFloat(document.getElementById('management-hours').value) || 0;
            ...
            // Update results
            document.getElementById('hosting-savings').textContent = '$' + hostingSavings.toFixed(2);
            document.getElementById('time-savings').textContent = '$' + timeSavings.toFixed(2);
            document.getElementById('total-savings').textContent = '$' + totalAnnualSavings.toFixed(2);
            ...
            recommendedPlanDiv.classList.remove('hidden');
          }
        `
      }} />
    </Layout>
