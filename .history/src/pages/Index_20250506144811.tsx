    ...
    <Layout>
      ...
      <section className="py-8 bg-midnight">
        <div className="container">
          ...
          {/* Changed to use Lucide icons instead of images */}
          <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-4 max-w-5xl mx-auto">
            {[
              { name: 'Debian', icon: <Terminal className="h-5 w-5 text-electric" strokeWidth={1.5} /> },
              { name: 'CentOS', icon: <Terminal className="h-5 w-5 text-electric" strokeWidth={1.5} /> },
              { name: 'Rocky Linux', icon: <Terminal className="h-5 w-5 text-cyber" strokeWidth={1.5} /> },
              { name: 'AlmaLinux', icon: <Terminal className="h-5 w-5 text-cyber" strokeWidth={1.5} /> },
              { name: 'Ubuntu', icon: <Terminal className="h-5 w-5 text-electric" strokeWidth={1.5} /> },
              { name: 'Fedora', icon: <Terminal className="h-5 w-5 text-cyber" strokeWidth={1.5} /> },
              { name: 'FreeBSD', icon: <Terminal className="h-5 w-5 text-electric" strokeWidth={1.5} /> },
              { name: 'Alpine Linux', icon: <Terminal className="h-5 w-5 text-cyber" strokeWidth={1.5} /> },
