...
import { Check, Zap, ShieldCheck, Clock, Users, Code, Cpu, HardDrive, Globe, Settings, Laptop, Server, Bot, Gamepad2, Repeat } from 'lucide-react';
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 rounded-lg bg-midnight/50 border border-white/10 card-hover">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                Run resource-intensive applications like game servers, trading bots, or automation tools with the power and control you need.
              </p>
            </div>
          </div>
        </div>
