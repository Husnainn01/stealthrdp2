          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-8 items-center max-w-4xl mx-auto">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="flex justify-center">
                <img 
                  src={`https://placehold.co/150x40/FFFFFF/CCCCCC?text=Client+${i}&font=montserrat`} 
                  alt={`Client Logo ${i}`} 
                  className="h-6 md:h-8 w-auto opacity-50 hover:opacity-90 transition-opacity"
                />
              </div>
            ))}
          </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 max-w-5xl mx-auto">
            ...
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-electric/10 flex items-center justify-center mb-4 text-electric font-montserrat font-bold text-2xl mx-auto ring-2 ring-electric/30">1</div>
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Choose Plan</h3>
              <p className="text-white/70 text-sm">Select the VPS resources that fit your needs.</p>
            </div>
            {/* Step 2 */}
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-electric/10 flex items-center justify-center mb-4 text-electric font-montserrat font-bold text-2xl mx-auto ring-2 ring-electric/30">2</div>
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Checkout Securely</h3>
              <p className="text-white/70 text-sm">Complete your order through our secure payment gateway.</p>
            </div>
            {/* Step 3 */}
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-electric/10 flex items-center justify-center mb-4 text-electric font-montserrat font-bold text-2xl mx-auto ring-2 ring-electric/30">3</div>
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Deploy Instantly</h3>
              <p className="text-white/70 text-sm">Receive your VPS login details and get started in minutes.</p>
            </div>
          </div>
        </div>
      </section>
