...
const Index = () => {
  ...
  return (
    <Layout>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/80 mb-8 max-w-3xl mx-auto fade-in" style={{ animationDelay: '0.2s' }}>
              Deploy in 60 seconds. Experience enterprise-grade power without the complexity or high costs.
            </p>
      ...
      {/* Trust Signals with Urgency - Based on the Focusing Effect and Social Proof */}
      <section className="py-8 bg-charcoal">
        <div className="container">
          ...
          {/* Limited Time Offer Banner - Triggers Urgency and Scarcity */}
          <div className="mt-8 py-2 px-4 bg-midnight rounded-md border border-electric/30 text-center max-w-xl mx-auto">
            <p className="text-sm text-white/90">
              <span className="text-electric font-medium">Limited Time Offer:</span> Get 30% off any 6-month plan. Use code <span className="font-mono font-bold text-cyber">POWER30</span> at checkout.
            </p>
          </div>
        </div>
      </section>
