...
const Index = () => {
  ...
  return (
    <Layout>
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-24 relative overflow-hidden bg-gradient-to-b from-charcoal to-midnight">
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Interactive Sales Elements - replacing Trust Signals */}
            <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-3 md:gap-x-8 text-white/80 text-sm fade-in" style={{ animationDelay: '0.6s' }}>
              <a href="#pricing" className="flex items-center gap-1.5 whitespace-nowrap hover:text-electric transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-cyber" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="#pricing" className="flex items-center gap-1.5 whitespace-nowrap hover:text-electric transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-electric" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M3 3v18h18"/>
                  <path d="M18.4 8.64L13.93 13.1l-2.46-2.46L6.8 15.29"/>
                </svg>
      ...
      <section className="py-8 bg-midnight">
        <div className="container">
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-4 md:gap-x-12 lg:gap-x-16 max-w-4xl mx-auto">
            {/* Action Element 1: Money-Back Guarantee */}
            <a href="#pricing" className="flex items-center gap-2 text-white/60 hover:text-white/90 transition-colors group">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-cyber group-hover:text-electric transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 2v20"/>
                <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>
              </svg>
              <span className="font-montserrat text-sm uppercase tracking-wider">7-Day Money-Back</span>
            </a>
            
            {/* Action Element 2: No Credit Card */}
            <a href="#pricing" className="flex items-center gap-2 text-white/60 hover:text-white/90 transition-colors group">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-electric group-hover:text-cyber transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect width="20" height="14" x="2" y="5" rx="2"/>
                <line x1="2" x2="22" y1="10" y2="10"/>
              </svg>
              <span className="font-montserrat text-sm uppercase tracking-wider">No Credit Card Required</span>
            </a>
            
            {/* Action Element 3: Instant Activation */}
            <a href="#pricing" className="flex items-center gap-2 text-white/60 hover:text-white/90 transition-colors group">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-cyber group-hover:text-electric transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                <path d="m9 11 3 3L22 4"/>
              </svg>
              <span className="font-montserrat text-sm uppercase tracking-wider">Instant Activation</span>
            </a>
            
            {/* Action Element 4: Price Lock */}
            <a href="#pricing" className="flex items-center gap-2 text-white/60 hover:text-white/90 transition-colors group">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-electric group-hover:text-cyber transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect width="18" height="11" x="3" y="11" rx="2" ry="2"/>
                <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
              </svg>
              <span className="font-montserrat text-sm uppercase tracking-wider">Price-Lock Guarantee</span>
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="bg-charcoal py-12 md:py-16">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Feature 1: Custom Solutions */}
            <div className="text-center p-6 rounded-lg bg-midnight/50 border border-white/10 card-hover">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-cyber mx-auto mb-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Customizable Solutions</h3>
              <p className="text-white/70 text-sm leading-relaxed">
                Build your own perfect VPS configuration with our flexible options, tailored to your exact workload requirements.
              </p>
            </div>
            
            {/* Feature 2: Enterprise-Grade Infrastructure */}
            <div className="text-center p-6 rounded-lg bg-midnight/50 border border-white/10 card-hover">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-electric mx-auto mb-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M2 9a7 7 0 0 1 12-5"></path>
                <path d="M15.5 5a7 7 0 0 1 0 14H2"></path>
                <path d="M20 16.5a7 7 0 0 1-14 0"></path>
                <circle cx="12" cy="12" r="3"></circle>
              </svg>
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Enterprise Infrastructure</h3>
              <p className="text-white/70 text-sm leading-relaxed">
                Access the same premium hardware that powers Fortune 500 companies, with redundant systems for maximum reliability.
              </p>
            </div>
            
            {/* Feature 3: Free Migration */}
            <div className="text-center p-6 rounded-lg bg-midnight/50 border border-white/10 card-hover">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-cyber mx-auto mb-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M16 18V6h6M8 6v12H2"></path>
                <path d="M12 10h8"></path>
                <path d="M12 14h8"></path>
                <path d="M4 10h8"></path>
                <path d="M4 14h8"></path>
              </svg>
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Free Migration Service</h3>
              <p className="text-white/70 text-sm leading-relaxed">
                Switch to StealthRDP without downtime. Our technicians will transfer your data and configurations at no extra cost.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-lg bg-midnight/50 border border-white/10 card-hover">
              ...
              <h3 className="text-xl font-semibold font-montserrat text-white mb-2">Transparent Pricing</h3>
              <p className="text-white/70 text-sm leading-relaxed">
                No hidden fees or surprise charges. Our straightforward pricing means you'll never pay more than expected.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-16 md:py-24 bg-midnight relative">
      ...
      {/* NEW: Interactive Savings Calculator */}
      <section className="py-12 md:py-16 bg-midnight">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-bold font-montserrat mb-3 text-white">
                See How Much You Could <span className="text-electric">Save</span>
              </h2>
              <p className="text-white/70 text-lg">
                Compare our pricing with competitors and see the value StealthRDP delivers
              </p>
            </div>
            
            <div className="bg-charcoal border border-white/10 rounded-xl p-6 md:p-8 shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-semibold font-montserrat text-white mb-5">Select Your Configuration</h3>
                  
                  <div className="space-y-6">
                    <div>
                      <label className="block text-white mb-2 text-sm">CPU Cores</label>
                      <div className="flex items-center gap-3">
                        <button className="w-10 h-10 rounded-md bg-midnight border border-electric/50 text-white hover:bg-electric/20 transition-colors">2</button>
                        <button className="w-10 h-10 rounded-md bg-electric text-midnight font-semibold">4</button>
                        <button className="w-10 h-10 rounded-md bg-midnight border border-electric/50 text-white hover:bg-electric/20 transition-colors">6</button>
                        <button className="w-10 h-10 rounded-md bg-midnight border border-electric/50 text-white hover:bg-electric/20 transition-colors">8</button>
                      </div>
                    </div>
                    
                    <div>
                      <label className="block text-white mb-2 text-sm">RAM Memory</label>
                      <div className="flex items-center gap-3">
                        <button className="w-14 h-10 rounded-md bg-midnight border border-electric/50 text-white hover:bg-electric/20 transition-colors">4GB</button>
                        <button className="w-14 h-10 rounded-md bg-midnight border border-electric/50 text-white hover:bg-electric/20 transition-colors">8GB</button>
                        <button className="w-14 h-10 rounded-md bg-electric text-midnight font-semibold">16GB</button>
                        <button className="w-14 h-10 rounded-md bg-midnight border border-electric/50 text-white hover:bg-electric/20 transition-colors">32GB</button>
                      </div>
                    </div>
                    
                    <div>
                      <label className="block text-white mb-2 text-sm">Storage (SSD)</label>
                      <div className="flex items-center gap-3">
                        <button className="px-3 h-10 rounded-md bg-midnight border border-electric/50 text-white hover:bg-electric/20 transition-colors">60GB</button>
                        <button className="px-3 h-10 rounded-md bg-electric text-midnight font-semibold">100GB</button>
                        <button className="px-3 h-10 rounded-md bg-midnight border border-electric/50 text-white hover:bg-electric/20 transition-colors">150GB</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t md:border-t-0 md:border-l border-white/10 pt-6 md:pt-0 md:pl-8">
                  <h3 className="text-xl font-semibold font-montserrat text-white mb-5">Monthly Savings</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center pb-3 border-b border-white/10">
                      ...
                      <span className="text-white font-semibold">$39.99</span>
                    </div>
                    
                    <div className="flex justify-between items-center pb-3 border-b border-white/10">
                      <span className="text-white">StealthRDP</span>
                      <span className="text-electric font-bold">$26.59</span>
                    </div>
                    
                    <div className="flex justify-between items-center pt-2">
                      <span className="text-white font-semibold">You Save Up To</span>
                      <span className="text-cyber font-bold text-xl">$23.40/mo</span>
                    </div>
                    
                    <div className="mt-6">
                      <Button asChild size="lg" className="w-full bg-cyber text-midnight hover:bg-cyber/90 font-bold uppercase text-base py-3">
                        <Link to="/plans">Get This Plan Now</Link>
                      </Button>
                    </div>
                  </div>
                </div>
