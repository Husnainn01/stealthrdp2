        ...
        <div className="container">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-4 max-w-5xl mx-auto">
            {[
              ...
              <div 
                key={index} 
                // Adjusted styling for horizontal layout
                className="flex items-center gap-2 text-center transition-all duration-300 hover:text-electric"
              >
                {/* Placeholder for actual logo */}
                <os.Icon className="h-5 w-5 text-electric flex-shrink-0" strokeWidth={1.5} /> 
