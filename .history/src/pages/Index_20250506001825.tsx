        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="plans-container">
              ...
              >
                {usaPlans.map((plan, index) => (
                  <SwiperSlide key={`usa-${index}`}>
                    <div className={`bg-midnight border ${plan.popular ? 'popular-plan border-2' : 'border-white/10'} rounded-xl overflow-hidden card-hover plan-card p-6`}>
                      {plan.popular && (
                      ...
                      {index === 0 && (
                        <div className="absolute top-2 left-2 bg-cyber px-2 py-1 rounded-lg text-xs text-midnight font-semibold">
                          STARTING FROM
                        </div>
                      )}
              ...
              >
                {euPlans.map((plan, index) => (
                  <SwiperSlide key={`eu-${index}`}>
                    <div className="bg-midnight border border-white/10 rounded-xl overflow-hidden card-hover plan-card p-6">
                      {index === 0 && (
                        <div className="absolute top-2 left-2 bg-cyber px-2 py-1 rounded-lg text-xs text-midnight font-semibold">
                          STARTING FROM
                        </div>
            ...
            <div className="plan-section">
              ...
              <div className="bg-midnight border border-white/10 rounded-xl overflow-hidden card-hover plan-card p-6 shadow-lg">
                <div className="plan-card-content">
