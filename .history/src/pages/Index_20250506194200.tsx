              ...
              <div className="p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-white/90 font-medium mb-2">With StealthRDP</h3>
                    <p className="text-white/60 text-sm">
                      "Our data processing runs on a VPS while I work uninterrupted on my local machine."
                    </p>
                    <div className="mt-4 flex items-center">
        ...
        <div className="container">
          ...
          <div className="mt-10 max-w-2xl mx-auto text-center">
            <p className="text-white/70 italic text-sm">
              "We switched to StealthRDP and saved over $3,000 annually compared to our previous VPS setup. The performance is better and we spend way less time on maintenance."
            </p>
