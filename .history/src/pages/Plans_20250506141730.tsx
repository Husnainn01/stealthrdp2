...
const Plans = () => {
  ...
  const [activeTab, setActiveTab] = useState<'usa' | 'eu' | 'custom'>('usa');
      ...
      <div className="py-20 md:py-28 bg-charcoal">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <Tabs 
            defaultValue="usa" 
            className="mb-10" 
            onValueChange={(value) => setActiveTab(value as 'usa' | 'eu' | 'custom')}
          >
            ...
            {/* NEW: Billing Cycle Toggle - Below location tabs, hidden on 'custom' */}
            {activeTab !== 'custom' && (
