    ...
    const getPurchaseUrl = () => {
      ...
      const urls = {
        ...
        'Bronze USA': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/standard-usa-rdp-vps/bronze-usa2&billingcycle=yearly',
        ...
        'Silver USA': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/standard-usa-rdp-vps/silver-usa&billingcycle=yearly',
        ...
        'Gold USA': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/standard-usa-rdp-vps/gold-usa&billingcycle=yearly',
        ...
        'Platinum USA': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/standard-usa-rdp-vps/platinum-usa&billingcycle=yearly',
        ...
        'Diamond USA': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/standard-usa-rdp-vps/diamond-usa&billingcycle=yearly',
        ...
        'Emerald USA': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/standard-usa-rdp-vps/emerald-usa&billingcycle=yearly',
        ...
        'Bronze EU': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/eu/bronze-eu&billingcycle=yearly',
        ...
        'Silver EU': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/eu/silver-eu&billingcycle=yearly',
        ...
        'Gold EU': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/eu/gold-eu&billingcycle=yearly',
        ...
        'Platinum EU': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/eu/platinum-eu&billingcycle=yearly',
        ...
        'Diamond EU': {
          ...
          annually: 'https://stealthrdp.com/dash/index.php?rp=/store/eu/diamond-eu&billingcycle=yearly',
