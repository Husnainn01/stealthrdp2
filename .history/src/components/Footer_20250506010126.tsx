  ...
  return (
    <footer className="bg-midnight py-10">
      ...
      <div className="container mx-auto px-4 mb-10">
        <div className="flex flex-col items-center justify-center bg-[#0B0F2D] border border-gray-800 rounded-lg p-6 max-w-3xl mx-auto">
          <div className="flex flex-col items-center mb-4">
            <h3 className="text-lg text-white font-montserrat font-semibold mb-2">Guaranteed Safe Checkout</h3>
            <div className="h-0.5 w-40 bg-gradient-to-r from-electric to-cyber mb-4"></div>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-6">
            ...
            <img src="/images/payment/discover.svg" alt="Discover" className="h-8" />
            <img src="/images/payment/shoppay.svg" alt="Shop Pay" className="h-8" />
            <img src="/images/payment/applepay.svg" alt="Apple Pay" className="h-8" />
            <img src="/images/payment/googlepay.svg" alt="Google Pay" className="h-8" />
          </div>
          <p className="text-gray-400 text-xs mt-4 text-center">
            Your payment is secured with 256-bit SSL encryption. We never store your credit card information.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/documentation" className="text-gray-400 hover:text-electric transition-colors">Documentation</Link></li>
