    ...
    <footer className="bg-midnight py-10">
      <div className="container mx-auto">
        ...
        <div className="mt-8 flex justify-center">
          <div className="bg-white p-3 rounded-lg max-w-md mx-auto">
            ...
            <div className="flex justify-center items-center gap-3 flex-wrap">
              ...
              <img src="/images/payment/discover.svg" alt="Discover" className="h-6" />
              <img src="/images/payment/shoppay.svg" alt="Shop Pay" className="h-6" />
              <img src="/images/payment/applepay.svg" alt="Apple Pay" className="h-6" />
